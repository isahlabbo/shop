...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <div class="card shadow">
            <div class="card-header btn btn-primary">{{$shop->name}} TOTAL REGISTERED PENDING WORKS PAYMENT</div>
	        <div class="card-body">
	            <table class="table">
	                <thead>
	                    <th>S/N</th>
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                    	...
	                    	<td><b>Total</b></td>
	                    	<td></td>
	                    	<td><b># {{$shop->availableUnPaidBalance()}}</b></td>
	                    	<td></td>
	                    </tr>
	                </tbody>
	            </table>
