<!-- modal -->
<div class="modal fade" id="class_{{$class->id}}" role="dialog">
      ...
      <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<form method="post" action="{{route('admin.shop.programme.class.update',[$shop->id, $programme->id, $class->id])}}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="date" class="form-control @error('duration') is-invalid @enderror" name="start" value="{{  $class->start }}" required autocomplete="name" autofocus>
                            @error('start')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="date" class="form-control @error('end') is-invalid @enderror" name="end" value="{{ $class->end }}" required autocomplete="name" autofocus>
